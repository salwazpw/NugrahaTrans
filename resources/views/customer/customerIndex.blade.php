                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('customer.destroy', $data->id) }}" method="POST">
                                <a class="btn btn-icons btn-primary" href="{{route('customer.show', $data->id)}}"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-icons btn-warning" href="{{route('customer.edit', $data->id)}}"><i class="fa fa-edit"></i></a>
                                @csrf
                                @method('DELETE')
